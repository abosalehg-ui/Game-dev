...
| التقنية | الاستخدام |
|---------|-----------|
| **Three.js** (r128 ES Modules) | المشاهد ثلاثية الأبعاد (مع تجميع الأشكال الساكنة ومشاركة الموارد) |
...
- **دين معروف:** Three.js المُضمَّن هو r128 (2021). ليست ثغرة أمنية، لكن الترقية
  إلى إصدار حديث تستحق نافذة عمل منفصلة — تغيّرت فيها واجهات الإضاءة وفضاء الألوان،
  فالترقية تحتاج مراجعة بصرية لكل المراحل الست وليست تبديل ملف.
