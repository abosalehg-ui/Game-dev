...
🆕 **الدفعة تُكمل بعد رفع إصبعك** ثم تهدأ تدريجياً — والمشهد يتوقف فوراً إن أمسكته من جديد.

**🎥 كشف سينمائي عند الترقية** 🆕
عند الانتقال لمكتب أكبر، الكاميرا **تتراجع تدريجياً لتكشف** المساحة الجديدة بدل القطع
المفاجئ. وعند إطلاق لعبة بتقييم عالٍ: **وميض في الإضاءة ودفعة في الكاميرا** مع القصاصات.

**🗣️ زملاء لا عمّال متوازون** 🆕
فقاعات حوار تظهر بين موظفَين متجاورَين بين حين وآخر، وموظف **يتمطّى** عند مكتبه من وقت
لآخر (بأطوار مختلفة، فلا يتمطّى الجميع معاً)، والعائد من ركن القهوة **يحمل كوبه في يده**
ويتأرجح مع خطواته.
...
**🧊 مجسمات بحواف مشطوفة** 🆕
كل قطعة أثاث وكل شخصية صارت **مشطوفة الحواف**: شريحة رفيعة بزاوية ٤٥° عند كل حافة
تلتقط الضوء، فيظهر خط مضيء على كل حدّ بدل الحافة الحادة المسطّحة. هذا وحده أكبر فرق
بين Low-Poly «افتراضي» وLow-Poly «مصمَّم».

**🖥️ شاشات حيّة** 🆕
شاشات المكاتب لم تعد لوحاً أزرق ثابتاً: كل شاشة تعرض محتوى يتحرك فعلاً — محرّر أكواد
يُكتب فيه، أو رسمة تُبنى بكسل بكسل، أو لوحة مبيعات. وتتسارع أثناء التطوير.

**👤 شخصيات حقيقية** 🆕
الموظف كان ٤ صناديق بلا أرجل. الآن له **أرجل تصل الأرض وأذرع تتدلى من الكتفين وشعر**،
وطول وبنية ولون بشرة تختلف من شخص لآخر — مشتقّة من اسمه، فتلازمه عبر الترقيات وإعادة
البناء. ومشيته تُحرّك الأرجل مع تأرجح معاكس للذراعين.

**☕ ركن قهوة حقيقي** 🆕
كان الموظفون يمشون إلى **بقعة فارغة** من الأرض. الآن هناك كاونتر وآلة قهوة بضوء تشغيل
وأكواب — في نهاية المشوار شيء يستحق المشي إليه. مع رفوف كتب على الجدران، وكراسي مدسوسة
تحت المكاتب، ونباتات بثلاثة أشكال بدل شكل واحد مكرّر.

**🎬 إخراج سينمائي** 🆕
المشهد يمر بسلسلة معالجة لاحقة (Post-processing) قبل أن يصل لشاشتك: **توهج (Bloom)**
للشاشات والنيون والكؤوس، و**عمق ميدان مائل (Tilt-Shift)** يجعل الاستوديو يبدو مجسّماً
مصغّراً حقيقياً، وتدرّج لوني وتظليل حواف. كل ذلك يعمل في فضاء لوني خطي عالي المدى (HDR)
ثم يُضغط بمنحنى ACES في النهاية.

**🌆 سماء ومدينة حيّة** 🆕
خلف الاستوديو أفق مدينة كامل يُرسم إجرائياً ويكبر معك: من ضاحية منخفضة في غرفة نومك إلى
أبراج بارتفاع ناطحة سحابك. السماء نفسها تُستخدم كـ**خريطة إضاءة بيئية (IBL)**، فتنعكس على
الزجاج والمعدن وتمنح كل سطح إضاءة غير مباشرة تختلف باختلاف اتجاهه.

**🌗 دورة نهار وليل**
الإضاءة تتغير مع تقدم السنة داخل اللعبة: صباح ← ظهيرة ← مساء ← ليل، مع توهج النوافذ ليلاً.
**الشمس تتحرك في قوس** عبر اليوم فتنزلق الظلال على الأرض، و**أعمدة ضوء** تدخل من النوافذ
عندما تكون الشمس منخفضة، ونوافذ المدينة تُضاء ليلاً.
...
ناطحة السحاب لم تعد آخر المحتوى بلا آخر للّعبة. عند القمة يظهر هدف واحد: **جائزة «لعبة العام» ثلاث سنوات متتالية**. سنة واحدة بلا جائزة تصفّر العدّاد، فالمطلوب استمرار على مستوى عالٍ لا ضربة حظ واحدة — وعدّاد ●●○ في اللوحة يريك كم بقي.

عند تحقيقه: شاشة تتويج، ثم اختيارك — تكمل باستوديوك كما هو بلا سقف، أو تبدأ جولة جديدة بمستويات Prestige.

### 🔊 صوت المكتب 🆕

طبقة صوت محيط مُولَّدة بالكامل (بلا أي ملف صوتي): همهمة خفيفة تتبع حجم استوديوك، وطقطقة كيبورد تتكثّف أثناء البناء وتخفت في الليل. تُطفأ من الإعدادات، وتتوقف تلقائياً إذا صار التبويب في الخلفية.
...
- إصدار الحفظ + هجرة آمنة للنسخ القديمة (v1 ← v6)
...
- التركيز محصور داخل النافذة المفتوحة، والخلفية `inert` — فلا يتوه Tab خلف طبقة
  معتمة لا تُقرأ، ويعود التركيز لمكانه عند الإغلاق
...
- سلايدر صوت + كتم
- وضع داكن/فاتح
- **جودة الرسوم** 🆕 — تلقائي / عالية / متوسطة / منخفضة / الأدنى
- عرض السنة و Prestige
- مسح الحفظ بأمان

**🎚️ جودة تتكيّف مع جهازك** 🆕
الوضع التلقائي يختار مستوى الجودة من إمكانيات جهازك، ثم **يقيس معدل الإطارات فعلياً**
ويخفّض المستوى إن لم يواكب — فالتأثيرات كلها محكومة بعدد البكسلات لا بعدد المجسّمات،
ما يجعل هاتفاً بشاشة عالية الكثافة هو الحالة الأصعب. الأجهزة بلا تسريع رسومي (بعض
الأجهزة الافتراضية والمتصفحات المقيّدة) تُكتشف وتبدأ من المستوى الأدنى مباشرة.
واختيارك اليدوي يُحترم ولا يُلغى تلقائياً.
...
16. **الهدف الأخير** 🆕 — في ناطحة السحاب، اربح «لعبة العام» **٣ سنوات متتالية**.
    سنة واحدة بلا جائزة تصفّر العدّاد، فالمطلوب استمرار لا ضربة حظ
17. **أفلست؟** — استخدم Prestige للبداية بقوة!
...
| التقنية | الاستخدام |
|---------|-----------|
| **Three.js r185** (ES Modules) | المشاهد ثلاثية الأبعاد — حزمة مُشذَّبة (≈134KB مضغوطة) مع تجميع الأشكال الساكنة ومشاركة الموارد |
| **HTML/CSS** | واجهة المستخدم |
| **خط Cairo** | مُضمَّن محلياً في `vendor/fonts/` (خط متغيّر، ثلاثة ملفات ≈79KB، العربي منها 32KB وهو الوحيد المُخزَّن مسبقاً) |
...
npm test                         # كل الاختبارات (عشر مجموعات، كلها في CI)
npm run test:smoke               # دورة تطوير كاملة في المتصفح
npm run test:topic               # اشتقاق الموضوع من الاسم (32 حالة) + تدفّق الاختيار اليدوي وقفل السلاسل
...
npm run test:fit                 # الغرفة كاملة على الشاشة في كل مرحلة وكل نسبة أبعاد وكل زاوية
npm run test:events              # كل حدث يذكر الرقم الذي يطبّقه فعلاً (مولّد من BALANCE)
npm run test:focus               # النوافذ تحصر التركيز فعلاً لا بالوعد فقط
npm run test:endgame             # شرط الفوز: القمة + ٣ جوائز متتالية، ويقع مرة واحدة
npm run test:formulas            # معادلات الدرجة والمبيعات والتكلفة على اللعبة الحقيقية + مطابقة ثوابت السيم
npm run test:rescue              # قرض الإنقاذ يستأنف تدفق ما بعد الإصدار مرة واحدة لا مرتين
...
npm run share                    # قياس حصة السوق على اللعبة الحقيقية (لا على النموذج)
...
- **موازنة اللعبة كلها في `BALANCE`** أعلى قسم «Release pipeline»، وجدول `STG`.
  ...
  و`npm run share` يقيس حصة السوق على اللعبة نفسها: السيم يمثّل الإصدارات الأساسية
  فقط، فأرقامه أرضية لا حكم (لا تسويق ولا عقود ولا معارض ولا جوائز).
- **نصوص الأحداث مولّدة لا مكتوبة:** وصف كل حدث في `EVENTS` يحمل رمزاً مثل
  `{sales}` يملأه `describeEvent()` من `BALANCE` وقت العرض. لا تكتب رقماً بيدك في
  وصف حدث — أربعة أوصاف انحرفت هكذا عمّا ينفّذه الكود، و`tests/event-text.mjs`
  يمنع تكرارها.
- **إطار الكاميرا يُقاس لا يُجدوَل:** `measureRoomFit()` يشتق نصف قطر الغرفة من
  الأجسام الساكنة بعد كل `buildRoom`، و`onResize()` يلائم المحور المُقيِّد.
  أي غرفة جديدة أوسع تُؤخذ تلقائياً، و`tests/viewport-fit.mjs` هو الحارس.
...
- **CI:** يعمل تلقائياً على كل PR: فحص الصياغة ← الدخان ← اشتقاق الموضوع ← سلامة الحفظ
  ← التنقّل ← ملاءمة الشاشة ← نصوص الأحداث ← حصر التركيز ← نهاية اللعبة ← جلسة طويلة
  ← تقرير الموازنة ← فحص إصدار الـ SW. والتثبيت بـ `npm ci` من ملف القفل المُلتزَم،
  فلا يتغيّر شجر التبعيات بين تشغيل وآخر.
- **ترقية Three.js:** `vendor/three.module.js` **مُولَّد** بـ `tools/build-three.mjs`
  (حزمة مُشذَّبة إلى 39 رمزاً فقط: ≈134KB مضغوطة مقابل 404KB للحزمة الكاملة). لا تعدّله
